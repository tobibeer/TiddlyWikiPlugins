...
***/
// /%
function placeholderIsSupported(){var e=document.createElement("input");return"placeholder"in e}(function(e){me=config.macros.listfiltr={InputPlaceholder:"filter list",InputLabel:"Filter list:",InputTooltip:"enter a search term to filter the list",defaultPreserve:"",handler:function(t,n,r,i,s,o){var u,a,f,l,c,h,p,d,v=s.parseParams("anon",null,true),m=getParam(v,"appendTo",this.appendTo),g=getParam(v,"preserve",this.defaultPreserve);if(m){c=e(t).closest(".tiddler");t=e(m,c).first()[0]||t}c=e(t).children().last();while(c.is("br"))c=c.prev();if(c.is("span, div"))c=c.contents();c.wrapAll('<div class="lf-list"/>');c=c.closest(".lf-list");if(e.fn.outline)e("ol:not(ol li > ol)",c).outline();e(g,c).addClass("lf-preserve");c.find(":not(iframe)").addBack().contents().filter(function(){var t=e(this);return this.nodeType==3&&(t.prev().is("br")||t.next().is("br"))&&0==t.closest(".lf-preserve").length&&0==t.prevAll(".pseudo-ol-li").length}).wrap('<span class="lf-p"/>');a=e("<div class=lf-search/>").insertBefore(c);p=placeholderIsSupported()?me.InputPlaceholder:"";if(!p){e("<span class=lf-label/>").html(me.InputLabel).appendTo(a)}u=e('<input type="search"/>').attr({title:me.InputTooltip,placeholder:p}).appendTo(a);u.bind("keyup search",function(){var t,n,r,i,s=e(this),o=s.val(),u=s.closest(".lf-search").next();o.length>1?u.addClass("lf-filtered"):u.removeClass("lf-filtered");e("li,dd,dt,span,div",u).removeClass("lf-h lf-hide lf-found lf-not").each(function(i){var s,u,a=e(this);if(o.length>1){r=a.clone().children().remove().end().text();t=a.children().not("dl,ol,ul").clone().remove("dl,ol,ul,dl *,ol *,ul *");r=r+" "+t.text();t.each(function(t){var n=e(this),i=n.hasClass("externalLink")?n.attr("href").replace("http://",""):null;tid=n.attr("tiddlyLink");r+=" "+(i?i:"")+(tid?" "+tid:"")});n=r.toLowerCase().indexOf(o.toLowerCase())>-1;a.not("br, .pseudo-ol-li").addClass("lf-"+(n?"found":"h"));if(a.is("dt")){u=a.nextUntil("dt","dd");if(n){u.addClass("lf-not")}}u=a.closest("dd");if(u.length){s=u.prevAll("dt:first");if(n){if(!s.hasClass("lf-found"))s.addClass("lf-not").removeClass("lf-h")}else if(s.hasClass("lf-found")){u.removeClass("lf-h")}}if(n){if(a.is(".listTitle")&&a.parent().hasClass("timeline")){a.parent().find("> li").each(function(){var t=e(this);if(!t.hasClass("lf-found"))t.addClass("lf-not")})}h=a.closest("li").parent().find("> .listTitle");if(h.length&&!h.hasClass("lf-found")){h.addClass("lf-not")}}}});e(".highlight:not(.tiddlyLink,.externalLink)",u).each(function(){e(this).after(e(this).text())}).remove();e(".highlight",u).removeClass("highlight");if(o.length>1){e(".lf-found",u).each(function(t){e(this).parentsUntil(i,".lf-h").removeClass("lf-h").not(".pseudo-ol-li").addClass("lf-not");e(".lf-h",this).removeClass("lf-h").not(".pseudo-ol-li").addClass("lf-not")});e.fn.highlight=function(t){var n=new RegExp("(\\b\\w*"+t+"\\w*\\b)","gi"),r='<span class="highlight">$1</span>';this.each(function(){e(this).contents().each(function(){if(this.nodeType===3&&n.test(this.nodeValue)){e(this).replaceWith(this.nodeValue.replace(n,r))}else if(!e(this).hasClass("highlight")){e(this).highlight(t)}})});return this};e("*",u).highlight(o);e(".externalLink, .tiddlyLink",u).each(function(){var t=e(this),n=(t.hasClass("tiddlyLink")?t.attr("tiddlyLink"):t.attr("href").replace("http://",""))||"";if(o.length>1&&n.indexOf(o)>-1)t.addClass("highlight")})}e("dt.lf-not .lf-h, li.lf-not.lf-h",u).removeClass("lf-h");e(".lf-not",u).children().not("ol, ul").find(".lf-h").removeClass("lf-h");e(".lf-h",u).addClass("lf-hide");return true})}};config.shadowTiddlers["StyleSheetListFiltr"]="/*{{{*/\n"+".lf-search {padding:5px;background:#eef;}\n"+".lf-hide {display: none !important;}\n"+".lf-found {background:#F5F5DC;}\n"+".lf-list + br {display:none;}\n"+".lf-label {margin-right:5px;font-weight:bold;}\n"+".lf-filtered .lf-p {display:block;}\n"+".lf-filtered br {display: none;}\n"+".lf-preserve.lf-found br {display: block;}\n"+"/*}}}*/";store.addNotification("StyleSheetListFiltr",refreshStyles)})(jQuery)
//%/