...
/%***/
config.extensions.id={format:"%0",length:21,base:undefined};TiddlyWiki.prototype.tiddlerId=function(e,t){if(typeof e!="string")e=e.title;var n=store.getValue(e,"id"),r=config.extensions.id,i=t||[];if(!n){console.log(Math.uuid(r.length,r.base));i.unshift(Math.uuid(r.length,r.base));n=r.format.format(i);store.setValue(e,"id",n)}return n};TiddlyWiki.prototype.getTiddlerById=function(e){var t;store.forEachTiddler(function(n,r){if(e===store.getValue(n,"id")){t=r;return false}});return t};(function(){var e="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split("");Math.uuid=function(t,n){var r=e,i=new Array(36);n=n||r.length;if(t){for(var s=0;s<t;s++)i[s]=r[0|Math.random()*n]}else{var o=0,u;for(var s=0;s<36;s++){if(s==8||s==13||s==18||s==23){i[s]="-"}else if(s==14){i[s]="4"}else{if(o<=2)o=33554432+Math.random()*16777216|0;u=o&15;o=o>>4;i[s]=r[s==19?u&3|8:u]}}}return i.join("")}})()
//%/